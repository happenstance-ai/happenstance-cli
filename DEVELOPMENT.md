...
**First-time setup**: Register `hpn-cli` on PyPI and configure trusted publishing to accept tokens from this repo's `publish-hpn-cli.yml` workflow with the `pypi` environment.
